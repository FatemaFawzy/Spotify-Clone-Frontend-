      ...
      <div className="sidebar">
        ...
        <Link to="/webplayer/HomePage"><img className="logo"  src="https://i.ya-webdesign.com/images/itunes-logo-white-png-1.png" alt="logo"/></Link>
          ...
          <ul>
              ...
              <li><Link  onClick={this.clickedinfo} id="infor" onClick={addNewURL("")} className="List2" to="/ArtistAccount/ArtistWebPlayer/MyInfo/"><i class="fas fa-info"></i>Info</Link></li>
