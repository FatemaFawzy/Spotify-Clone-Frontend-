    ...
    <div className="wrapper">
      ...
      <div className="sidebar">
        ...
        <img className="logo"  src="https://i.ya-webdesign.com/images/itunes-logo-white-png-1.png" alt="logo"/>
          ...
          <ul>
              <li onClick={addNewURL("/webplayer/HomePage")}><NavLink className="List" to="/webplayer/HomePage"><i className="fas fa-home"></i>Home</NavLink></li>
              <li onClick={addNewURL("/webplayer/search/")}><NavLink className="List" to="/webplayer/search/"><i className="fas fa-search" aria-hidden="true"></i>Search</NavLink></li>
              <li onClick={addNewURL("/webplayer/yourlibrary/")}><NavLink className="List" to="/webplayer/yourlibrary/"><i className="fas fa-bookmark" aria-hidden="true"></i>Your library</NavLink></li>
