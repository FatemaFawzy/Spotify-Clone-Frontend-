    ...
    return (
      ...
      <div className="music-bar d-flex align-items-center pt-0 pb-0">
          ...
          <div className="row">
            ...
            <div className="music-bar-left col pl-0">
              ...
              <div className="card pl-0">
                <div className="row no-gutters">
                  ...
                  <div className="col-2 ">
                    <img className="card-img song-photo" src={!this.props.adsModeOn?Tracks[this.state.trackNum].imgURL:"https://media-exp1.licdn.com/dms/image/C560BAQHpg-r-l1OuMw/company-logo_200_200/0?e=2159024400&v=beta&t=OpcQBP3_pWwy8srJcQHoDHxaUH9MRN1RPaV5ZzKoUEY"}></img>
                      ...
                      <ul className="list-group list-group-horizontal">
                        ...
                        <li className="pr-2 prevent-overflow">
                          <div className="song-name prevent-overflow">
                            <a id="song-name" href={this.state.albumLink}> {!this.props.adsModeOn?Tracks[this.state.trackNum].SongName:"Ad Audio"} </a>
                            
                          </div>

                          <div className="artist-name prevent-overflow">
                            <a id="artist-name" href={this.state.artistProfileLink}> {!this.props.adsModeOn?Tracks[this.state.trackNum].Artist:"Spotify"} </a>
                          </div>
                        </li>
            ...
            <div className="music-bar-middle">
              <div className="d-flex justify-content-center">
                ...
                <button className="middle-icons fas fa-step-backward" title="Previous" onClick={(!this.props.adsModeOn)&&this.playPrevious}></button>
                <button id="play-track-bar" className="play middle-icons far fa-play-circle mr-3 ml-3" onClick={this.playPause} ></button>
                <button className="middle-icons fas fa-step-forward" title="Next" onClick={(!this.props.adsModeOn)&&this.playNext}></button>
              ...
              <div className="duration-bar d-flex">
                ...
                <div id="music-progress" className="progress" onClick={(!this.props.adsModeOn)&&this.handleProgress}>
        ...
        <audio ref="player" loop={this.props.playOnRepeat}>
          ...
          <source src={!this.props.adsModeOn?Tracks[this.state.trackNum].songURL:AdsAudio} />
        </audio>
      </div>
    )
  };
