		...
		return(
			...
			<div className="container">
				...
				<form method="POST">
					...
					<div className="d-flex justify-content-center"><Link to="/logIn/forgotpassword/success" className="buttonSpacing d-flex justify-content-center"><a className="btn btn-success px-5 py-2 mt-4 padded" id="anchor" role="button">SEND</a></Link></div>
